...
type DeleteStockHandlerFunc func(DeleteStockParams, *utils.TokenPayload) middleware.Responder

// Handle executing the request and returning a response
func (fn DeleteStockHandlerFunc) Handle(params DeleteStockParams, principal *utils.TokenPayload) middleware.Responder {
	return fn(params, principal)
}

// DeleteStockHandler interface for that can handle valid delete stock params
type DeleteStockHandler interface {
	Handle(DeleteStockParams, *utils.TokenPayload) middleware.Responder
}
