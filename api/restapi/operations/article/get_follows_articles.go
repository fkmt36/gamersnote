...
type GetFollowsArticlesHandlerFunc func(GetFollowsArticlesParams) middleware.Responder

// Handle executing the request and returning a response
func (fn GetFollowsArticlesHandlerFunc) Handle(params GetFollowsArticlesParams) middleware.Responder {
	return fn(params)
}
...
type GetFollowsArticlesHandler interface {
	Handle(GetFollowsArticlesParams) middleware.Responder
}
